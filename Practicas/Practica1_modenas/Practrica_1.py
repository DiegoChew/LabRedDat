...
import math
# Título de la página
st.title("Práctica 1- Distribución binomial en lanzamientos de monedas")
 # Texto a mostrar
...
m=st.slider("Ingrese la cantidad de intentos",1,100)
...
binomial_plot.add_bar(x=repeat_counts_index.index,y=repeat_counts_index.values/m, name="Lanzamientos experimentales", marker_color='#CA6F1E')
...
st.write('Para ver la tabla de datos graficados, pulse el botón que esta debajo de este texto')
